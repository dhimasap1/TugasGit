    ...
    <div class="page-content">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Add Data Rumah Sakit</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12 stretch-card">
                <div class="card">
                    <div class="card-body">
                        <form action="{{route('rumahsakit.add')}}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="mb-3">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" name="telp" autocomplete="off" placeholder="Nomor Telp">
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea type="text" class="form-control" name="alamat" autocomplete="off" placeholder="Alamat"></textarea>
                                    </div>
                                </div>
                            </div>
